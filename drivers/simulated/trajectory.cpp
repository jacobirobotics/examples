...
int main(int argc, char *argv[]) {
    cxxopts::Options options("simulated-driver", "Run a pre-calculated trajectory on a simulated robot.");
    options.add_options()
        ...
        ("without-studio", "Don't sync with Studio Live.", cxxopts::value<bool>()->default_value("false"))
    ...
    auto driver = std::make_shared<SimulatedDriver>(planner, !args["without-studio"].as<bool>());
